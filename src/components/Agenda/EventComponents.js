...
class EventTop extends React.Component {
    render() {
        ...
        const composer = this.props.composer.replace("<br>", "");
        return (
            <div className="event-top">
                <div className="composer"
                            dangerouslySetInnerHTML={{__html:composer}}/>
                <div className="title-centerer"><div className="title"
                            dangerouslySetInnerHTML={{__html:this.props.title}}/></div>
