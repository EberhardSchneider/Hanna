...
const Impressum = () => (
<div className="impressum-overlay">
	<div className="impressum-text">
		...
		<p><h2>KONTAKT</h2>
			hannaherfurtner(at)gmail.com</p>
		...
		<p><h2>URHEBERRECHT</h2>
			Die erstellten Inhalte und Werke auf diesen Seiten unterliegen dem deutschen Urheberrecht. Die Vervielfältigung, Bearbeitung, Verbreitung und jede Art der Verwertung außerhalb der Grenzen des Urheberrechtes bedürfen der schriftlichen Zustimmung des jeweiligen Autors bzw. Erstellers. Downloads 
		...
		<p><h2>FOTONACHWEIS BANNER</h2>
			VITA © Marco Borggreve / HÖREN © Karl Forster/ KONTAKT  © Ursula Kaufmann</p>

		<p><h2>GESTALTUNG</h2>
			 Anna Derriks & Hanna Herfurtner  </p>

		<p><h2>PROGRAMMIERUNG</h2>
			Eberhard Schneider / www.eberhardschneider.info</p>
			<p><h2><a href="/admin.php">SITE ADMIN</a></h2></p>
